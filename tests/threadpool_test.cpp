...
// TEST_F(struct_threadpool, DefaultConstructor) { EXPECT_EQ(threadpool_empty(pool), true); }

TEST_F(struct_threadpool, AddTask) {
  threadpool_add(pool, struct_threadpool::thread_function, &struct_threadpool::sv);
