...
FUN_MIN_COVERAGE := 90.00
LIN_MIN_COVERAGE := 70.00
REG_MIN_COVERAGE := 75.00
...
check_coverage: coverage
	...
	minimum=$(BRA_MIN_COVERAGE); \
	if [ $$(echo "$$average < $$minimum" | bc -l) -eq 1 ]; then \
		echo "Branch coverage is below $$minimum%!"; \
		exit 1; \
	else \
		echo "Branch coverage   => $$average%"; \
	fi; \
	coverage_sum=0; \
	count=0; \
	...
	average=$$(echo "scale=2; $$coverage_sum / $$count" | bc); \
	minimum=$(FUN_MIN_COVERAGE); \
	if [ $$(echo "$$average < $$minimum" | bc -l) -eq 1 ]; then \
		echo "Function coverage is below $$minimum%!"; \
		exit 1; \
	else \
		echo "Function coverage => $$average%"; \
	fi; \
	coverage_sum=0; \
	count=0; \
	...
	average=$$(echo "scale=2; $$coverage_sum / $$count" | bc); \
	minimum=$(LIN_MIN_COVERAGE); \
	if [ $$(echo "$$average < $$minimum" | bc -l) -eq 1 ]; then \
		echo "Line coverage is below $$minimum%!"; \
		exit 1; \
	else \
		echo "Line coverage     => $$average%"; \
	fi; \
	coverage_sum=0; \
	count=0; \
	...
	average=$$(echo "scale=2; $$coverage_sum / $$count" | bc); \
	minimum=$(REG_MIN_COVERAGE); \
	if [ $$(echo "$$average < $$minimum" | bc -l) -eq 1 ]; then \
		echo "Region coverage is below $$minimum%!"; \
		exit 1; \
	else \
		echo "Region coverage   => $$average%"; \
	fi;
